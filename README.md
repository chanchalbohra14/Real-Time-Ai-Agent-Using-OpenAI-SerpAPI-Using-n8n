# 🧠 Built a real-time, context-aware AI agent using n8n as the automation tool, integrating OpenAI for language understanding and SerpAPI for real-time web data access
